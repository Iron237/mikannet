...
# 只公开封面缓存。绝不能把整个 data_dir 挂成静态目录：其中含 SQLite 数据库、
# 日志以及保存于 Setting/NotificationConfig 的 Cookie、令牌和本机路径。
_IMAGES = settings.data_dir / "images"
_IMAGES.mkdir(parents=True, exist_ok=True)
app.mount("/data/images", StaticFiles(directory=_IMAGES), name="data-images")
